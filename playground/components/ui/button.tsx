...
const buttonVariants = cva(
  // Sharp corners throughout (owner direction, 2026-07-12) — rounded-none
  // overrides shadcn's default rounded-lg; every size variant below also
  // drops its own rounded-[...] override so nothing re-rounds a corner.
